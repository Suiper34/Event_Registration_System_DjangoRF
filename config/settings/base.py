...
# ensure ALLOWED_HOSTS is a list of non-empty hosts
_raw_allowed = environ.get('ALLOWED_HOSTS', '')
ALLOWED_HOSTS = [host for host in _raw_allowed.split(',') if host
...
# enable Session + Token authentication and sensible defaults
REST_FRAMEWORK = {
    ...
    # enable nicer browsable API pagination and formats for development
